---
title: 'Week 3: Data visualisation with R'
output:
...
- [What graph should I use?](#what-graph-should-I-use-?)
- [Histograms](#histograms)
- [Density plots](#density-plots)
- [Box plots](#box-plots)
- [Scatter plots with two variables](#scatter-plots-with-two-variables)
- [Scatter plots conditioning in a third v variable](#scatter-plots-conditioning-in-a-third-variable)
- [Scatterplot matrix](#scatterplot-matrix)
- [Titles and legends in ggplot2](#titles-and-legends-in-ggplot2)
- [Plotting categorical data: bar charts](#plotting-categorical-data-bar-charts)
