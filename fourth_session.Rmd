---
title: 'WEEK 5: Foundations of statistical inference: confidence intervals'
output:
...
[Sampling data and sampling variability](#sampling-data-and-sampling-variability).
[Sampling distributions, sampling experiments, and the central limit theorem](#sampling-distributions-and-sampling-experiments).
[The normal distribution and confidence intervals](#the-normal-distribution-and-confidence-intervals).
[Computing confidence intervals for means and proportions with R](#computing-confidence-intervals-for-means-and-proportions-with-r).
[A brief intro to resampling and bootstraping](#a-brief-intro-to-resampling-and-bootstrapping)
[What about comparisons? Sampling distribution for the difference of two means](#what-about-comparisons-sampling-distribution-for-the-differences-of-two-means).
[Comparing means visually by using error bars representing confidence intervals: inference by eye](#comparing-means-visually-by-using-error-bars-representing-confidence-intervals-inference-by-eye)
