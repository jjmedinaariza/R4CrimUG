---
title: "WEEK 9: An introduction to regression"
output:
...
- [Motivating regression](#motivating-regression)
- [Fitting a simple regression model](#fitting-a-simple-regression-model)
- [Residuals revisited: R square](#residuals-revisited-r-square)
- [Inference with regression](#inference-with-regression)
- [Fitting regression with categorical predictors](#fitting-regression-with-categorical-predictors)
- [Motivating multiple regression](#motivating-multiple-regression)
- [Fitting and interpreting a multiple regression model](#fittin-and-interpreting-a-multiple-regresssion-model)
- [Presenting your regression results](#presenting-your-regression-results)
- [Rescaling input variables to assist interpretation](#rescaling-input-variables-to-assist-interpretation)
- [Testing conditional hypothesis: interactions](#testing-conditional-hypothesis-interactions)
- [Model building and variable selection](#model-building-and-variable-selection)
