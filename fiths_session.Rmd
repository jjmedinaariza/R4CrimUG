---
title: "WEEK 6: Studying relationships between a categorical and a quantitative variable"
output:
...
- [Comparing means across two groups (the t test)](#comparing-means-across-two-groups-the-t- test).
- [Comparing means across several groups (ANOVA)](#comparing-means-across-several-groups-anova).
