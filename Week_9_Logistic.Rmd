...
- [Section 9.1: Introduction](#introduction)
- [Section 9.2: Fitting and presenting logistic regression](#fitting-logistic-regression)
- [Section 9.3: Assessing model fit I: deviance and pseudo r squared](#assessing-model-fit-i-deviance-and-pseudo-r-squared)
- [Section 9.4: Assessing model fit II: confusion matrix and ROC curves](#assessing-model-fit-ii-confusion-matrix-and-roc-curves)
- [Section 9.5: Interactions](#interactions)
- [Section 9.6: Further resources](#further-resources)
...
##9.2 Fitting logistic regression {#fitting-logistic-regression}
...
##9.3  Assessing model fit I: deviance and pseudo r squared {#assessing-model-fit-i-deviance-and-pseudo-r-squared}
...
##9.5 Assessing model fit II: confusion matrix and ROC curves {#assessing-model-fit-ii-confusion-matrix-and-roc-curves}
...
##9.6 Further resources {#further-resources}
